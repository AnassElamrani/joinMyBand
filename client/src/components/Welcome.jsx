import {
  ...
  Logout,
  EnterButton,
} from "../styled/StyledWelcome.styled";
      ...
      {!loggedin ? (
        <StyledWelcome>
          <LeftDiv>
            ...
            <p>
              Make it easy to chat with people that share the music love with ,
              you can make friends here and more just by choosing your username
              and a room to enter
            </p>
          </LeftDiv>
          <RightDiv>
